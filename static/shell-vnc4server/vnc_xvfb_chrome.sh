...
function install_chrome(){
    log "install chrome"
    sudo apt-get --yes --force-yes install libappindicator1 libdbusmenu-glib4 libdbusmenu-gtk4 libindicator7 libpango1.0-0 libpangox-1.0-0
    wget http://devops.dealerfire.com:81/mirror/dl.google.com/linux/chrome/deb/pool/main/g/google-chrome-stable/google-chrome-stable_66.0.3359.181-1_amd64.deb
    dpkg -i google-chrome-stable_66.0.3359.181-1_amd64.deb
...
function create_user(){
    ...
    curl -L https://xing393939.github.io/static/vendor/shell-install/chromedriver-v2.38.tar.gz > /home/xingchen/c.gz
    ...
    tar zvxf /home/xingchen/c.gz -C /home/xingchen
    chmod +x /home/xingchen/geckodriver
    chmod +x /home/xingchen/chromedriver
...
function create_service(){
    ...
    curl -L https://xing393939.github.io/static/vendor/shell-install/vnc_chrome.sh > /etc/init.d/vnc.sh
